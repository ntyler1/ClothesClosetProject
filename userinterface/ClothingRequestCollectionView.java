...
//==============================================================================
public class ClothingRequestCollectionView extends View
{
	...
	//--------------------------------------------------------------------------
	public ClothingRequestCollectionView(IModel icv)
	{
		super(icv, "ClothingRequestCollectionView");
	...
	protected void getEntryTableModelValues()
	{
		...
		try
		{
			ClothingRequestCollection requestCollection = 
	 		...
	 		Vector entryList = (Vector)requestCollection.getState("ClothingRequestList");
			...
			if (entryList.size() > 0)
			{
				...
				while (entries.hasMoreElements() == true)
				{
					...
					tableData.add(nextTableRowData);
                                ...
                                if(entryList.size() == 1)
                                    actionText.setText(entryCnt+" Clothing Request Found!");
                                else 
                                    actionText.setText(entryCnt+" Clothing Requests Found!");
                                    
                               actionText.setFill(Color.LIGHTGREEN);
			}
			else
			{
				actionText.setText("No Clothing Requests Found!");
	...
	private VBox createFormContent()
	{
		...
		idColumn.setCellValueFactory(
	                new PropertyValueFactory<ClothingRequestTableModel, String>("id"));
		
		TableColumn netIdColumn = new TableColumn("Net ID") ;
		netIdColumn.setMinWidth(35);
		...
		tableOfRequests.getColumns().addAll(idColumn, netIdColumn, fnColumn, lnColumn, phoneColumn, genderColumn, atColumn, 
	...
	protected void processInventorySelected()
	{
		...
		if(selectedItem != null)
		{
			...
			myModel.stateChangeRequest("InventorySelected", selectedId);
		}
	}
