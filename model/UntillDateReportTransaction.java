...
//==============================================================
public class UntillDateReportTransaction extends Transaction
{
	 ...
	 */
	//----------------------------------------------------------
	public UntillDateReportTransaction() throws Exception
	{
		super();
	...
	public void processTransaction(Properties props)
	{
		...
		myInventoryList.findUntillDate();
		try
		{	    
	...
	{
		Scene currentScene = myViews.get("UntillDateReportView");
		if (currentScene == null)
		{
			// create our initial view
			View newView = ViewFactory.createView("UntillDateReportView", this);
